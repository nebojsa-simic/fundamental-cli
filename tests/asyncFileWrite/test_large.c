...
int cli_main(void) {
  fun_console_write_line("Testing async file write with LARGE templates...\n\n");
  
  // Test 1: Write small file (should work)
  fun_console_write_line("Test 1: Small string (35 bytes)\n");
  ErrorResult err = write_file("test_small.txt", "Hello, World!\nThis is a test.\n");
  ...
  fun_console_write_line("Test 3: Large string (~1500 bytes) - REPRODUCES BUG\n");
