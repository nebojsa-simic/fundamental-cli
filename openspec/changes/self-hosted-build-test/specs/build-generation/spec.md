...
Build scripts SHALL include a comprehensive set of fundamental vendor modules sufficient for complex projects.
...
- **THEN** system recursively scans `src/**/*.c` for source files using real directory traversal
