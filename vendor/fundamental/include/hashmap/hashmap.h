...
// Usage: DEFINE_HASHMAP_TYPE_CUSTOM(Point, int, fun_hash_Point,
// fun_equals_Point)
#define DEFINE_HASHMAP_TYPE_CUSTOM(K, V, HASH_FN, EQUALS_FN)                   \
  ...
  static inline ErrorResult fun_hashmap_##K##_##V##_contains(                  \
    ...
    return fun_hashmap_contains(&map->map, &key, out);                         \
                                                                               ...
                                                                               \
  static inline ErrorResult fun_hashmap_##K##_##V##_remove(K##V##HashMap *map, \
                                                           K key) {            \
...
// Usage: DEFINE_HASHMAP_TYPE_STRUCT(Point, int) for struct Point { int x; int
// y; }
...
// Usage: DEFINE_HASHMAP_TYPE(int, char) creates IntCharHashMap,
// fun_hashmap_IntChar_*, etc.
...
#define DEFINE_HASHMAP_STRING_KEY(V)                                           \
  ...
  static inline ErrorResult fun_hashmap_String_##V##_put(                      \
    ...
    return fun_hashmap_put(&map->map, &key, &value);                           \
                                                                               ...
                                                                               \
  static inline V fun_hashmap_String_##V##_get(const String##V##HashMap *map,  \
                                               char *key) {                    \
    V value;                                                                   \
    ErrorResult result = fun_hashmap_get(&map->map, &key, &value);             \
    (void)result;                                                              \
