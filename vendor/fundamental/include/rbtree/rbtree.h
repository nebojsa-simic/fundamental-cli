...
// Usage: DEFINE_RBTREE_TYPE_CUSTOM(Point, int, fun_hash_Point, fun_equals_Point)
#define DEFINE_RBTREE_TYPE_CUSTOM(K, V, HASH_FN, EQUALS_FN)                    \
	...
	{                                                                          \
		...
		return result;                                                         \
                                                                               ...
                                                                               \
	static inline ErrorResult fun_rbtree_##K##_##V##_insert(                   \
		K##V##RBTree *tree, K key, V value)                                    \
	{                                                                          \
	...
	{                                                                          \
		...
		return value;                                                          \
                                                                               ...
                                                                               \
	static inline ErrorResult fun_rbtree_##K##_##V##_remove(                   \
		K##V##RBTree *tree, K key)                                             \
	{                                                                          \
...
#define DEFINE_RBSET_TYPE_CUSTOM(K, HASH_FN, EQUALS_FN)                   \
	...
	{                                                                     \
		return fun_rbtree_insert(&set->tree, &key, NULL);                 \
                                                                          ...
                                                                          \
	static inline ErrorResult fun_rbset_##K##_contains(const K##Set *set, \
													   K key, bool *out)  \
	{                                                                     \
