...
static inline uint64_t fun_collections_hash_bytes(const void *key,
                                                  size_t size) {
...
static inline bool fun_collections_equals_int32(const void *k1,
                                                const void *k2) {
  return *(const int32_t *)k1 == *(const int32_t *)k2;
}

static inline bool fun_collections_equals_int64(const void *k1,
                                                const void *k2) {
  return *(const int64_t *)k1 == *(const int64_t *)k2;
}

static inline bool fun_collections_equals_uint32(const void *k1,
                                                 const void *k2) {
  return *(const uint32_t *)k1 == *(const uint32_t *)k2;
}

static inline bool fun_collections_equals_uint64(const void *k1,
                                                 const void *k2) {
...
static inline bool fun_collections_equals_string(const void *k1,
                                                 const void *k2) {
